...
/**
 * @dev Idea for this function is to be called from test/proxy-contracts/*
 * when transaction needs to be made.
 *
 */
export default function proxyExecute() {
  const app = {};
  let txAttr = {};
  const txAttrSaved = {};
  ...
  app.setFromVar = async (_from) => {
    ...
    if (debug) console.log('[proxyExecute] new `txAttr.from` balance', balance, 'ETH');
  };
